...
create_histogram(ig.locations, 'avg_time')
```
...
The average time spent at a location for the intersection differes much more, with values between 0 and 24hours for the raster-based method, and up to 4 days for the point-based method. 
